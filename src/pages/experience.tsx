...
const experienceData: ExperienceData[] = [
  {
    ...
    additionalInformation:
      "Specializes in teaching subjects like Virtual Reality, Mixed Reality, Culture Technology, and Geo-informatics.",
    highlights: [
  ...
  },
  {
    ...
    organization: "Sejong University, South Korea",
    additionalInformation:
      "Leads research in XR technologies with a focus on creating a realistic interconnected metaverse.",
    highlights: [
  ...
  },
  {
    ...
    role: "Research Professor",
    institution:
      "Mobile Virtual Reality Research Center, Information Technology Research Center",
    organization: "Sejong University, South Korea",
    additionalInformation:
      "Conducted research in VR, MR, and GIS under the Ministry of Science and ICT support program supervised by the IITP.",
    highlights: [
  ...
  },
  {
    ...
    additionalInformation:
      "Developed a background in leadership, supervised Master's and Ph.D. students, and contributed to research projects bridging South Korean and Iranian research efforts.",
    highlights: [
  ...
  },
  {
    ...
    additionalInformation:
      "Participated in discussions and delivered seminars on Ubiquitous GIS and spatially enabled systems.",
    highlights: [
...
const industryExperienceData = [
  {
    ...
    period: "2016 - 2017",
    additionalInformation:
      "Involved in consulting on GIS and related technologies for Korean companies.",
    highlights: [
  ...
  },
  {
    ...
    period: "Summer 2005",
    additionalInformation:
      "Worked on intelligent transportation systems (ITS) and GIS applications.",
    highlights: [
  ...
  },
  {
    ...
    additionalInformation:
      "Managed IT and GIS projects, recognized as a top researcher by the Iranian President.",
    highlights: [
  ...
  },
  {
    ...
    additionalInformation:
      "Oversaw institute operations and project management for various computer-related programs.",
    highlights: [
