  ...
  return (
    ...
    >
      ...
      <main className="relative pt-20 px-4 md:px-8 max-w-7xl mx-auto bg-transparent">
        ...
        {/* Hero Section */}
        <section
          className={`min-h-screen flex flex-col md:flex-row items-center justify-between py-12 md:py-20 ${darkMode ? "text-white" : "text-gray-800"}`}
        >
          {/* Profile Image */}
          <motion.div
            ...
            >
              ...
              <motion.button
                ...
                whileHover={{
                  scale: 1.05,
                  boxShadow: darkMode
                    ? "0px 0px 8px rgb(59, 130, 246)"
                    : "0px 0px 8px rgb(29, 78, 216)",
                }}
                whileTap={{ scale: 0.95 }}
              >
                Explore Research
        ...
        <section className="py-12 md:py-20">
          <h2
            className={`text-3xl md:text-4xl font-bold mb-8 text-center ${darkMode ? "text-white" : "text-gray-800"}`}
          >
            Research Highlights
          </h2>
...
export default function Home() {
  ...
  return (
    <div
      className={`relative min-h-screen overflow-x-hidden transition-colors duration-300 ${darkMode ? "text-white bg-black" : "text-gray-800 bg-gray-100"}`}
    >
