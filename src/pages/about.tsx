...
import { BookOpen, Award, Lightbulb, Globe, GraduationCap, Beaker, Building2, Users, Code, Brain } from 'lucide-react';
...
const Card = ({ children, darkMode }: { 
  ...
  <div className={`rounded-lg shadow-lg p-6 transition-colors duration-300
    ${darkMode 
      ? 'bg-gray-900 border border-gray-700' : 'bg-white'} 
    ${darkMode
...
<div className="mb-12">
  ...
  <div className="text-center mb-8">
    <h1 className="text-4xl font-bold mb-4">Dr. Abolghasem Sadeghi-Niaraki</h1>
    <p className="text-xl text-gray-600">
      Associate Professor at Sejong University | Harvard SDL Fellow | Top 2% Scientist
    </p>
  </div>
          ...
          <Card darkMode={darkMode}>
            <div className="prose max-w-none">
              <p className="text-lg mb-6 dark:text-gray-300">
                Dr. Abolghasem Sadeghi-Niaraki is an Associate Professor in the Department of Computer Science and Engineering at the XR (eXtended Reality) Metaverse Research Center, Sejong University, Republic of Korea, where he has been a faculty member since 2017. Recently appointed as a Fellow at Harvard University's Spatial Data Lab (SDL), he conducts collaborative research in spatiotemporal data analytics, visualization, and geo-AI-based platforms, contributing to innovative geographic data applications and natural hazards research.
              </p>
              <p className="text-lg mb-6">
                With a strong academic foundation and over 15 years of experience, Dr. Sadeghi-Niaraki has established himself as a prolific researcher advancing the fields of Geo-AI, GIS, HCI, IoT, and Metaverse technologies. His groundbreaking research in Geo-AI, Virtual Reality (VR), Mixed Reality (MR), and Extended Reality (XR) applications, supported by the Korean Ministry of Science and ICT, has pushed the boundaries of immersive technologies in spatial data systems.
              </p>
<div className={`my-8 border-t ${darkMode ? 'border-gray-700' : 'border-gray-200'}`} />
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                ...
                <div className="space-y-4">
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    <li>Top 2% Scientist Worldwide (Stanford-Elsevier 2024)</li>
          ...
          <Card darkMode={darkMode}>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold">Ph.D. in Geo-Informatics Engineering</h3>
                  <p className="text-gray-600">INHA University, South Korea</p>
              ...
              <div className="flex items-start space-x-4">
                <GraduationCap className="w-6 h-6 mt-1" />
                <div>
                  <h3 className="text-lg font-semibold">M.Sc. in GIS Engineering</h3>
                  <p className="text-gray-600">K.N. Toosi University of Technology</p>
              ...
              <div className="flex items-start space-x-4">
                <GraduationCap className="w-6 h-6 mt-1" />
                <div>
                  <h3 className="text-lg font-semibold">Post-Doctoral Fellowship</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold">Stanford-Elsevier Top 2% Scientist</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold">Harvard SDL Fellowship</h3>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold">Australian Endeavour Fellowship</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold">Best Researcher Award</h3>
                    <p className="text-gray-600">International Soil Scientist Awards, 2024</p>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div className="space-y-8">
                      <div>
                        ...
                        <div className="space-y-4">
                          <div className="border-l-4 border-blue-500 pl-4">
                            <h4 className="font-semibold">Super-Realistic XR Technology Research Center</h4>
                            <p className="text-gray-600">Director, 2022 - 2030</p>
                            <p className="text-sm mt-2">Leading cutting-edge research in Real-Virtual Interconnected Metaverse technologies</p>
                          </div>
                          <div className="border-l-4 border-green-500 pl-4">
                            <h4 className="font-semibold">Mobile Virtual Reality Research Center</h4>
                            <p className="text-gray-600">Research Professor, 2017 - 2021</p>
                            <p className="text-sm mt-2">Managed international collaboration with 14 universities across 8 countries</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <ul className="space-y-2">
                          <li>• Established international postgraduate programs with KAIST</li>
                          <li>• Led Korea Knowledge Sharing Program (KSP) projects</li>
                          <li>• Consulting for major Korean companies including HANCOM Group</li>
                          <li>• Implemented innovative solutions at Gimpo Airport</li>
                        </ul>
                      </div>
                    </div>
                  </Card>
...
{activeTab === 'skills' && (
        ...
        {activeTab === 'research' && (
          <Card darkMode={darkMode}>
            <div className="space-y-6">
              <h3 className="text-xl font-semibold mb-4">Major Research Projects</h3>
              <div className="space-y-4">
                <div className="border-l-4 border-blue-500 pl-4">
                  <h4 className="font-semibold">Super-Realistic XR Technology Research</h4>
                  <p className="text-gray-600">2022 - 2030</p>
                  <p className="text-sm">Funding: ~750,000 USD per year</p>
                  <p className="text-sm mt-2">Research for Real-Virtual Interconnected Metaverse applications</p>
                </div>
                <div className="border-l-4 border-green-500 pl-4">
                  <h4 className="font-semibold">Mobile Virtual Reality Research Center</h4>
                  <p className="text-gray-600">2016 - 2021</p>
                  <p className="text-sm">Funding: ~660,000 USD per year</p>
                  <p className="text-sm mt-2">International collaboration across 14 universities and 11 companies</p>
                </div>
                <div className="border-l-4 border-purple-500 pl-4">
                  <h4 className="font-semibold">Knowledge Sharing Project (KSP)</h4>
                  <p className="text-gray-600">2016 - 2017</p>
                  <p className="text-sm">Funding: 300,000 USD</p>
                  <p className="text-sm mt-2">Strategic consulting with ETRI and VPST</p>
                </div>
              </div>
            </div>
          </Card>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-blue-500 pl-4">
                    ...
                    <p>Department of Computer Science & Engineering, Sejong University</p>
                  ...
                  <div className="border-l-4 border-purple-500 pl-4">
                    ...
                    <p>Department of Geoinformatic Engineering, INHA University</p>
                    <p className="text-gray-600">March 2009 - February 2017</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {activeTab === 'service' && (
          <Card darkMode={darkMode}>
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-semibold mb-4">Editorial Positions</h3>
                <ul className="space-y-3">
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mr-2"></div>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4">Academic Supervision</h3>
                <ul className="space-y-2">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li>• Senior Member, International Engineering and Technology Institute</li>
                  <li>• Member, American Association of Geographers (AAG)</li>
                </ul>
              </div>
            </div>
          </Card>
        ...
        {activeTab === 'contact' && (
          <Card darkMode={darkMode}>
            <div className="space-y-8">
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <h4 className="font-semibold mb-2">Research Centers</h4>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4">Teaching & Mentorship</h3>
                <p className="mb-4">
                  With over 15 years of academic experience, I am committed to fostering the next generation of computer scientists and researchers. My teaching philosophy emphasizes hands-on experience with cutting-edge technologies while building strong theoretical foundations.
                </p>
                <p>
                  I have supervised over 40 Master's and 6 Ph.D. students, guiding research in areas including Geo-AI, XR technologies, and spatial computing. My approach combines rigorous academic standards with practical industry relevance.
                </p>
              </div>
            </div>
          </Card>
