  ...
  return (
    <Html>  {/* Correct capitalization */}
      <Head>
        ...
        {/* Meta tags for SEO */}
        <meta name="description" content="Dr. Abolghasem Niaraki-Sadeghi - Expertise in IT, XR, AR, and AI" />
        <meta property="og:title" content="Dr. Abolghasem Niaraki-Sadeghi" />
        <meta property="og:description" content="Explore research, teaching, and professional experience in technology." />
