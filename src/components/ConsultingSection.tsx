...
interface ConsultingSectionProps { //describe properties of consulting section
  ...
  const ConsultingSection: React.FC<ConsultingSectionProps> = ({ //a styled, responsive section showcasing consulting & collaboration data
