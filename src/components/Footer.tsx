          ...
          <React.Fragment key={`row-${rowIndex}`}>
            {Array.from({ length: columns }).map((_, colIndex) => {
              ...
              return isAnimated ? (
                ...
                <GridCell darkMode={darkMode} key={`cell-${rowIndex}-${colIndex}`} />
              );
            })}
          </React.Fragment>
        ))}
      ...
      <div className="relative container mx-auto px-4 md:px-8">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div variants={itemVariants}>
              <div className={`p-6 rounded-xl backdrop-blur-sm ${
                ...
                <h3 className={`text-xl font-bold mb-4 flex items-center gap-2 ${
                  ...
                  <Cpu className={`h-5 w-5 ${darkMode ? 'text-blue-400' : 'text-blue-500'}`} />
            ...
            <motion.div variants={itemVariants}>
              <div className={`p-6 rounded-xl backdrop-blur-sm h-full ${
                darkMode 
                  ? 'bg-gray-800/40 border border-gray-700/50' 
                  : 'bg-white/80 border border-gray-200'
              }`}>
                <h3 className={`text-xl font-bold mb-4 flex items-center gap-2 ${
                  ...
                  <Database className={`h-5 w-5 ${darkMode ? 'text-blue-400' : 'text-blue-500'}`} />
                  Research Focus
                </h3>
            ...
            <motion.div variants={itemVariants}>
              <div className={`p-6 rounded-xl backdrop-blur-sm h-full relative overflow-hidden ${
                darkMode 
                  ? 'bg-gray-800/40 border border-gray-700/50' 
                  : 'bg-white/80 border border-gray-200'
              }`}>
                ...
                <div className="absolute right-0 top-0 w-32 h-32 overflow-hidden pointer-events-none">
                  <div className={`absolute -right-4 -top-4 w-16 h-16 rotate-45 transform origin-bottom-left ${
                ...
                <h3 className={`text-xl font-bold mb-4 flex items-center gap-2 ${
                  ...
                  <Terminal className={`h-5 w-5 ${darkMode ? 'text-blue-400' : 'text-blue-500'}`} />
                  Website
                </h3>
                <div className={`mb-4 flex items-center ${
                  ...
                  <span className="font-medium">Designed & Developed & Published by</span>
                </div>
                ...
                <div className={`p-4 rounded-lg relative ${
                  ...
                  {/* Subtle glow effect */}
                  <div className={`absolute -inset-px rounded-lg blur-sm ${
