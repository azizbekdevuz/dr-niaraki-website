  ...
  const teachingRoles = [
    {
      ...
      description:
        "Teaching various courses in Virtual Reality, AI, Geo-informatics, supervising multiple graduate students, and contributing to interdisciplinary academic research.",
      icon: School,
      stats: {
        students: "200+",
        projects: "45+",
    ...
    },
    {
      ...
      description:
        "Taught and developed curriculum in spatial analysis and GIS, supervising both Master's and Ph.D. students in advanced geo-informatics.",
      icon: GraduationCap,
      stats: {
        students: "150+",
        projects: "30+",
    ...
    },
    {
      ...
      description:
        "Summer semesters focused on advanced GIS and spatial technologies.",
      icon: Award,
      stats: {
        students: "50+",
        projects: "10+",
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="mt-16">
          <div className="text-center mb-12">
            ...
            >
              Comprehensive curriculum spanning multiple disciplines
            </p>
          </div>
