      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16 items-center">
          ...
          >
            ...
            >
              Dr. Abolghasem Sadeghi-Niaraki, an Iranian scholar and researcher,
              is an Associate Professor at Sejong University, specializing in
              Geo-AI, XR, and GIS. His journey in academia and industry spans
              over 15 years, driven by a commitment to advancing technology and
              education.
            </p>
          </motion.div>
