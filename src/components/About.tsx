  ...
  return (
    ...
    >
      ...
      {[...Array(5)].map((_, i) => (
        ...
        >
          <Sparkles className={`w-6 h-6 ${darkMode ? 'text-blue-400/30' : 'text-blue-600/30'}`} />
        </motion.div>
      ))}
                ...
                <div className="space-y-6">
                  <div className="w-full">
                    ...
                    >
                      ...
                      <div className={`grid grid-cols-3 gap-4 mt-6 p-4 rounded-lg ${
                        ...
                        >
                            ...
                            <div className="flex-1">
                              <div className="flex items-start gap-4">
                                <div className={`p-3 rounded-lg ${
                                  ...
                                  <Network className={darkMode ? "text-blue-400" : "text-blue-600"} size={24} />
                                </div>
                                <div>
                                  <h4 className={`text-xl font-bold ${
                                    darkMode ? textSystem.dark.primary : textSystem.light.primary
                          ...
                          <AnimatePresence>
                            {expandedExp === index && (
                              ...
                              >
                                <p className={darkMode ? textSystem.dark.tertiary : textSystem.light.tertiary}>
                                  {exp.details}
                                </p>
                                    ...
                                    {exp.projects.map((project, i) => (
                                      ...
                                      >
                                        <div className="flex items-center gap-2">
                                          <Star className={darkMode ? "text-blue-400" : "text-blue-600"} size={16} />
                                          <span>{project}</span>
                                        </div>
                                      </motion.div>
                                    ))}
                                ...
                                <div className="space-y-4">
                                  ...
                                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {exp.achievements.map((achievement, i) => (
                                      ...
                                      >
                                        <div className="flex items-center gap-2">
                                          <ChevronRight className={darkMode ? "text-blue-400" : "text-blue-600"} />
           ...
           <ScrollReveal>
              <div className="mb-32">
                <motion.div className="flex items-center justify-center gap-3 mb-16">
                  <Calendar className={darkMode ? "text-blue-400" : "text-blue-600"} size={40} />
                            ...
                            >
                              <div className={`flex-1 ${index % 2 === 0 ? "text-right" : "text-left"}`}>
                                ...
                                >
                                  ...
                                  <p className={`text-lg mt-2 ${darkMode ? textSystem.dark.secondary : textSystem.light.secondary}`}>
                                    {item.institution}
                                  </p>
                                  <p className={`text-base mt-2 ${darkMode ? "text-blue-400" : "text-blue-600"}`}>
                                    {item.year}
                                  </p>
              ...
              <div className="mb-32">
                <motion.div className="flex items-center justify-center gap-3 mb-16">
                  <Briefcase className={darkMode ? "text-blue-400" : "text-blue-600"} size={40} />
                  <h3 className={`text-4xl font-bold ${
                    darkMode ? textSystem.dark.primary : textSystem.light.primary
                  }`}>Professional Experience</h3>
                </motion.div>
                            ...
                            >
                              <div className="flex justify-between items-start">
                                <div className="flex-1">
                                  <div className="flex items-start gap-6">
                                    <div className={`p-4 rounded-lg ${
                                      ...
                                      <Network className={darkMode ? "text-blue-400" : "text-blue-600"} size={32} />
                                    </div>
                                    <div>
                                      <h4 className={`text-2xl font-bold ${
                                        darkMode ? textSystem.dark.primary : textSystem.light.primary
                                      ...
                                      <p className={`text-base mt-1 ${darkMode ? "text-blue-400" : "text-blue-600"}`}>
                                        {exp.duration}
                                      </p>
                                    </div>
                                  </div>
                                ...
                                <motion.div
                                  ...
                                  transition={{ duration: 0.3 }}
                                >
                                  <ChevronDown className={darkMode ? "text-blue-400" : "text-blue-600"} size={32} />
                                </motion.div>
                              </div>
                                        ...
                                        {exp.projects.map((project, i) => (
                                          ...
                                          >
                                            <div className="flex items-center gap-3">
                                              <Star className={darkMode ? "text-blue-400" : "text-blue-600"} size={20} />
                                    ...
                                    <div className="space-y-6">
                                      ...
                                      <div className="grid grid-cols-2 gap-6">
                                        {exp.achievements.map((achievement, i) => (
                                          ...
                                          >
                                            <div className="flex items-center gap-3">
                                              <ChevronRight className={darkMode ? "text-blue-400" : "text-blue-600"} size={20} />
              ...
              <div className="mb-32">
                <motion.div className="flex items-center justify-center gap-3 mb-16">
                  <Award className={darkMode ? "text-blue-400" : "text-blue-600"} size={40} />
                  <h3 className={`text-4xl font-bold ${
                    darkMode ? textSystem.dark.primary : textSystem.light.primary
                  }`}>Awards and Recognition</h3>
                </motion.div>
                              ...
                              <AnimatePresence>
                                {hoveredAward === index && (
                                  ...
                                  >
                                    ...
                                    <div className={`inline-block px-6 py-3 rounded-full text-base ${
                                      darkMode
                                        ? "bg-blue-500/20 text-blue-300"
                                        : "bg-blue-100 text-blue-800"
                                    }`}>
