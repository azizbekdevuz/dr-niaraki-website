...
interface MainContentProps {
  ...
  const MainContent: React.FC<MainContentProps & { textSystem: typeof textSystem }> = ({
    isLoaded,
    darkMode,
    setDarkMode,
    imageHovered,
    ...
    return (
      ...
      >
        ...
        >
          <Link href="/">
          <span className={`text-xl md:text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${
