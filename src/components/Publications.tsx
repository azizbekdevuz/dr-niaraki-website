  ...
  const publications = [
    {
      ...
      description:
        "Fine-tuning KNN algorithm for flood susceptibility mapping in natural hazards research.",
    ...
    },
    {
      ...
      description:
        "Pioneering methods for early-stage plant disease detection using advanced AI.",
    ...
    },
    {
      ...
      description:
        "Exploring multi-pollution variability with geospatial AI-driven modeling.",
      journal: "International Journal of Digital Earth",
      year: "2024",
      type: "research",
    },
    {
      ...
      description:
        "Deep learning advancements for multimodality imaging in tumor diagnosis.",
    ...
    },
    {
      ...
      description:
        "Developing immersive VR games for education using GIS and AR.",
    ...
    },
    {
      ...
      description:
        "Combining ensemble machine learning with evolutionary algorithms.",
